class Lexicon:
    ...
    # Quota
    quota_full_1 = "Participation not possible."
    quota_full_2 = "Thank you for your interest in participating in this study. Unfortunately, the quota for your demographic group has already been filled. Therefore, you cannot participate in this study. You will be redirected back."
    ...
    attention_check_1_error_label = "You did not pass the attention check. Redirecting…"
