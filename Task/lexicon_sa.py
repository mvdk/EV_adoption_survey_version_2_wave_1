class Lexicon:
    ...
    electricity_cost_text = "An electric vehicle needs electricity for driving, which is typically cheaper per kilometer than gasoline and diesel. This attribute represents the <b>electricity costs per 100 kilometers driven</b> in this electric vehicle. The total costs are determined by the efficiency of the electric vehicle, the costs to produce and distribute the electricity, and governmental taxes."
    gasoline_cost_text = "This attribute represents the <b>gasoline costs per 100 kilometers driven</b> for a gasoline-fueled vehicle of comparable size to the electric vehicle of this offer. These costs are determined by the typical fuel efficiency of cars of this size, the costs to produce and distribute gasoline, and governmental taxes. By comparing the gasoline costs to the electricity costs of the electric vehicle, you can calculate how much money you would save each month by driving electric instead of gasoline."
